...
{
    // $server = new \Bytedance\Token\Server($appid, $secret);
...
function doPoiTest($client): void
{
    ...
    // $avg_price = 35;
    // $poi = new \Bytedance\Model\Poi($sid, $business_name, $branch_name, $province, $city, $district, $address, $telephone, $categories, $offset_type, $longitude, $latitude, $photo_list, $recommend, $special, $introduction, $open_time, $avg_price);
...
function doCardTest($client): void
{
    ...
    // $date_info = new \Bytedance\Model\DateInfo(1, time(), time() + 3600 * 24 * 30, 0, 0);
    // $sku = new \Bytedance\Model\Sku(100);
    // $base_info = new \Bytedance\Model\BaseInfo($logo_url, $brand_name, $code_type, $title, $color, $notice, $description, $date_info, $sku);
    // $card = new \Bytedance\Model\Gift($base_info, '礼品测试券');
    ...
    // // [ticket] => gQE58ToAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL0hFVDNvU0RsRzFWaThCNTlubThrAAIE6u5tVwMEgDPhAQ== [expire_seconds] => 31536000 [url] => http:\/\/Bytedance.qq.com\/q\/HET3oSDlG1Vi8B59nm8k [show_qrcode_url] => https:\/\/mp.Bytedance.qq.com\/cgi-bin\/showqrcode?ticket=gQE58ToAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL0hFVDNvU0RsRzFWaThCNTlubThrAAIE6u5tVwMEgDPhAQ%3D%3D
    // print_r($ret);
    ...
    // // [ticket] => gQHU7joAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL0FrVGd5c1BsTWxWTGFnd29pV01rAAIEWe9tVwMEAKd2AA== [expire_seconds] => 7776000 [url] => http:\/\/Bytedance.qq.com\/q\/AkTgysPlMlVLagwoiWMk [show_qrcode_url] => https:\/\/mp.Bytedance.qq.com\/cgi-bin\/showqrcode?ticket=gQHU7joAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL0FrVGd5c1BsTWxWTGFnd29pV01rAAIEWe9tVwMEAKd2AA%3D%3D
    // print_r($ret);
    ...
    // $date_info = new \Bytedance\Model\DateInfo(1, time(), time() + 3600 * 24 * 30, 0, 0);
    // $sku = new \Bytedance\Model\Sku(200);
    // $base_info = new \Bytedance\Model\BaseInfo($logo_url, $brand_name, $code_type, $title, $color, $notice, $description, $date_info, $sku);
    // $base_info->card_id = $card_id;
    // $card = new \Bytedance\Model\Gift($base_info, '礼品测试券2');
